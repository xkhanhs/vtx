...
- **Gõ qua Chrome Remote Desktop bị nhảy dấu** → bật VTX trên máy ĐANG BỊ điều khiển, không phải máy đang ngồi gõ. Tab `remotedesktop.google.com` tự passthrough (cần quyền Accessibility để đọc URL); hai bộ gõ cùng sửa một chuỗi phím thì con trỏ nhảy loạn.
